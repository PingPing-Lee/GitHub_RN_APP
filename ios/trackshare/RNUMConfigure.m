...
+(void)configUSharePlatforms
{
  ...
  [UMSocialGlobal shareInstance].universalLinkDic =@{@(UMSocialPlatformType_WechatSession):@"https://github.com/PingPing-Lee",
  @(UMSocialPlatformType_QQ):@"https://github.com/PingPing-Lee",
   @(UMSocialPlatformType_Sina):@"https://github.com/PingPing-Lee"};

...
import { PopularItem, BackPressComponent, NavigationBar, SafeAreaViewPlus } from '../component';
...
class SearchPage extends Component {
  constructor(props) {
    super(props);
    // fix this.params = this.props.navigation.state.params;
  ...
  render() {
    ...
    let indicatorView = isLoading ? (
      <ActivityIndicator style={styles.centering} size="large" animating={isLoading} />
    ) : null;
    let resultView = (
      <View style={{ flex: 1 }}>
        {indicatorView}
